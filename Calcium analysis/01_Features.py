...
input_file = 'F:/02-Recording/02-Calcium/30min_ScrambledKO/E7/E7_cell_tracks_and_coordinates.npy'
output_file = 'F:/02-Recording/02-Calcium/30min_ScrambledKO/E7/E7_cell_data_features.npy'
output_pdf = 'F:/02-Recording/02-Calcium/30min_ScrambledKO/E7/E7_cell_tracks_spikes.pdf'

Lineage_stacks = {
         'gad_N': 'F:/02-Recording/02-Calcium/30min_ScrambledKO/00-Lineage/GadN+.tif',
         'gad_X': 'F:/02-Recording/02-Calcium/30min_ScrambledKO/00-Lineage/GadN-.tif',
         'glut_N': 'F:/02-Recording/02-Calcium/30min_ScrambledKO/00-Lineage/GlutN+.tif',
         'glut_X': 'F:/02-Recording/02-Calcium/30min_ScrambledKO/00-Lineage/GlutN-.tif',
    }

Dependancy_stacks = {
         'Ascl1b_Gad': 'F:/02-Recording/02-Calcium/30min_ScrambledKO/01-Dependancy/Ascl1b_Gad_dependant.tif',
         'Neurog1_Gad': 'F:/02-Recording/02-Calcium/30min_ScrambledKO/01-Dependancy/Ngn1_Gad_dependant.tif',
         'Ptf1a_Gad': 'F:/02-Recording/02-Calcium/30min_ScrambledKO/01-Dependancy/Ptf1a_Gad_dependant.tif',
         'Atoh1a_Gad': 'F:/02-Recording/02-Calcium/30min_ScrambledKO/01-Dependancy/Atoh1a_Gad_dependant.tif',
         'Ascl1b_Glut': 'F:/02-Recording/02-Calcium/30min_ScrambledKO/01-Dependancy/Ascl1b_Glut_dependant.tif',
         'Neurog1_Glut': 'F:/02-Recording/02-Calcium/30min_ScrambledKO/01-Dependancy/Ngn1_Glut_dependant.tif',
         'Ptf1a_Glut': 'F:/02-Recording/02-Calcium/30min_ScrambledKO/01-Dependancy/Ptf1a_Glut_dependant.tif',
         'Atoh1a_Glut': 'F:/02-Recording/02-Calcium/30min_ScrambledKO/01-Dependancy/Atoh1a_Glut_dependant.tif',
    }

Time_stack = 'F:/02-Recording/02-Calcium/30min_ScrambledKO/02-Birthdate/birth_time_gradient.tif'
...
def extract_features(input_path=input_file, output_path=output_file, use_parallel=True, max_workers=None,
    ...
    # Apply temporal matching
    processed_cells = temporal_matching(processed_cells, Time_stack)
    ...
    # Apply reference stack evaluation
    if isinstance(Dependancy_stacks, dict):
        for feature_name, stack_path in Dependancy_stacks.items():
            print(f"\nEvaluating cells against reference stack for feature: {feature_name}")
            processed_cells = spatial_correlation(processed_cells, stack_path, feature_name=feature_name)
        # Determine best match after all references have been evaluated
        processed_cells = determine_best_match(processed_cells, Dependancy_stacks, 'Dependancy', 5)
    ...
    features_to_compare = ['num_spikes', 'average_spike_width', 'average_spike_amplitude', 
                           'spectral_entropy', 'avg_sync_all', 'Birthdate']
